...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget _leftPanel(double width) {
    // safe fallback jika asset tak ada
    ...
    return Container(
      ...
      child: Stack(children: [
        ...
        // --- ganti bagian Positioned yang lama dengan ini ---
Positioned(
        ...
        child: Center(
          child: ConstrainedBox(
            ...
            child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.stretch, children: [
              ...
              Align(alignment: Alignment.centerRight, child: TextButton(onPressed: () => ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Forgot (demo)'))), child: const Text('Forgot password?'))),
              ...
              const SizedBox(height: 18),
              Center(child: Wrap(children: [const Text("Don't have an account? "), TextButton(onPressed: () {}, child: const Text('Sign up'))])),
            ]),
          ),
        ),
      ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      // Scaffold memberikan Material ancestor sehingga TextField tidak error
      body: LayoutBuilder(builder: (ctx, constraints) {
        ...
        if (wide) {
          ...
          // stacked vertical (mobile) — left image di atas, form di bawah (ketika tinggi rendah form digulung)
